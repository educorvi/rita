...
/******/ (() => {
            ...
            /***/ (
                ...
                function _copyAndTrimNpmrcFile(
                    ...
                    let npmrcFileLines = fs__WEBPACK_IMPORTED_MODULE_0__
                        ...
                        .toString()
                        .split('\n');
                    npmrcFileLines = npmrcFileLines.map((line) =>
                        (line || '').trim()
                    );
                    const resultLines = [];
                    ...
                    for (const line of npmrcFileLines) {
                        ...
                        if (lineShouldBeTrimmed) {
                            ...
                            resultLines.push(
                                '; MISSING ENVIRONMENT VARIABLE: ' + line
                            );
                        } else {
                ...
                function syncNpmrc(
                    ...
                    try {
                        if (
                            fs__WEBPACK_IMPORTED_MODULE_0__.existsSync(
                                sourceNpmrcPath
                            )
                        ) {
                            ...
                            fs__WEBPACK_IMPORTED_MODULE_0__.unlinkSync(
                                targetNpmrcPath
                            );
                        }
                    } catch (e) {
  ...
  \*******************************************/
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            ...
            /* harmony export */ installAndRun: () =>
                /* binding */ installAndRun,
        ...
        function _ensureFolder(folderPath) {
            if (!fs__WEBPACK_IMPORTED_MODULE_1__.existsSync(folderPath)) {
                const parentDir =
                    path__WEBPACK_IMPORTED_MODULE_3__.dirname(folderPath);
        ...
        function _ensureAndJoinPath(baseFolder, ...pathSegments) {
            ...
            try {
                for (let pathSegment of pathSegments) {
                    ...
                    if (
                        !fs__WEBPACK_IMPORTED_MODULE_1__.existsSync(joinedPath)
                    ) {
        ...
        function _getRushTempFolder(rushCommonFolder) {
            const rushTempFolder =
                process.env[RUSH_TEMP_FOLDER_ENV_VARIABLE_NAME];
        ...
        function _resolvePackageVersion(
            ...
            if (version.match(/^[a-zA-Z0-9\-\+\.]+$/)) {
                ...
                try {
                    ...
                    (0,
                    _utilities_npmrcUtilities__WEBPACK_IMPORTED_MODULE_4__.syncNpmrc)(
                        sourceNpmrcFolder,
                        rushTempFolder,
                        undefined,
                        logger
                    ...
                    const npmViewVersionOutput =
                        npmVersionSpawnResult.stdout.toString();
        ...
        function findRushJsonFolder() {
            if (!_rushJsonFolder) {
                ...
                do {
                    ...
                    basePath !==
                    (tempPath =
                        path__WEBPACK_IMPORTED_MODULE_3__.dirname(basePath))
        ...
        function installAndRun(
            ...
            try {
                ...
                const shouldUseShell =
                    binPath.includes(' ') &&
                    os__WEBPACK_IMPORTED_MODULE_2__.platform() === 'win32';
                const platformBinPath = shouldUseShell
                    ? `"${binPath}"`
                    : binPath;
        ...
        function _run() {
            ...
            runWithErrorAndStatusCode(logger, () => {
                const rushJsonFolder = findRushJsonFolder();
                const rushCommonFolder = _ensureAndJoinPath(
                    rushJsonFolder,
                    'common'
                );
